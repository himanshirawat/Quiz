...
export const AuthLogin = () => {
    ...
    const handleTestCredentialsClick = () => {
        const token = loginHandler("Himanshi", "123Himanshi");
        authDispatch({
            type: "TOKEN",
            payload: token
        })
            ...
            <div className="login-auth d-flex direction-column justify-center">
                ...
                <form onSubmit={handleLoginClick}>
                    <div className="form-container">
                        ...
                        <input value={username} className="form-input lh-ls" placeholder="username" onChange={handleUserNameChange}/>
                    </div>
                    <div className="form-container">
                        <label className="form-label">Password</label>
                        <input value={password} className="form-input lh-ls" placeholder="pasword" onChange={handlePasswordChange}/>
                    </div>
                    <div className="cta">
